...
class DB {
  // initial connection
  public static $dbName = 'stream_main';
  public static $user = 'stream_admin';
  public static $password = 'PWr82T9BaDKwZW6u1L';
...
class MeekroDB {
  // initial connection
  public $dbName = 'stream_main';
  public $user = 'stream_admin';
  public $password = 'PWr82T9BaDKwZW6u1L';
...
function meekrodb_error_handler($params) {
  ...
  file_put_contents('/home/stream/logs/api/mysql.error', implode("\n", $out), FILE_APPEND | LOCK_EX);
